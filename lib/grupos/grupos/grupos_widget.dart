...
class GruposWidget extends StatefulWidget {
  const GruposWidget({super.key});

  @override
  State<GruposWidget> createState() => _GruposWidgetState();
}
