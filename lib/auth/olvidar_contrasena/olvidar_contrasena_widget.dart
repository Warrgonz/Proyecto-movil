                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 24.0),
                                      child: Text(
                                        '¿Olvidaste tu contraseña? Ingrese el correo registrado con tu usuario para restablecer tu contraseña.',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: const Text(
                                                      'Contraseña enviada'),
                                                  content: const Text(
                                                      'Hemos enviado la solicitud para restablecer la contraseña a tu correo.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
