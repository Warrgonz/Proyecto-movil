    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            Visibility(
              visible: (valueOrDefault(currentUserDocument?.rol, '') ==
                      '\'root\'') ||
                ...
                child: Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed('NuevoAnuncioParroquial');
                      },
                      child: Icon(
                        Icons.add_box,
          ...
          child: StreamBuilder<List<AnunciosRecord>>(
            stream: queryAnunciosRecord(
              queryBuilder: (anunciosRecord) =>
                  anunciosRecord.orderBy('fechaEvento', descending: true),
              limit: 15,
            ),
            builder: (context, snapshot) {
              ...
              List<AnunciosRecord> listViewAnunciosRecordList = snapshot.data!;
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    listViewAnunciosRecord.fechaEvento,
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily: 'Inter',
