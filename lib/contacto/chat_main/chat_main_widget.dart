          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Aqui puedes ver tus conversaciones',
                ...
                child: StreamBuilder<List<ChatRecord>>(
                  stream: queryChatRecord(
                    queryBuilder: (chatRecord) => chatRecord
                        ...
                        .orderBy('Envio_Ultimo_Mensaje', descending: true),
                  ),
                          ...
                          child: InkWell(
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    if (listViewChatRecord.usuario.length <=
                                        2) {
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            16.0, 12.0, 12.0, 12.0),
